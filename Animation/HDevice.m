...
- (NSString *)UUIDString
{
    ...
    dispatch_once(&onceToken, ^{
            ...
            ([savedUuidString length] > 0))
        {
            ...
            //从keychain读取日志
            [[QIYILogUtils shareLogUtils] writeGeneralLogWithString:[NSString stringWithFormat:@"HDevice UUIDString:从keychain取UUIDString:%@",savedUuidString]];
        ...
        //重新生成UUID日志
        [[QIYILogUtils shareLogUtils] writeGeneralLogWithString:[NSString stringWithFormat:@"HDevice UUIDString:新生成UUIDString:%@",result]];
